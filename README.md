...
**Установщик**: [`D1CT-1.5.2-setup.exe`](https://github.com/metawka/SuperDictate-win/releases/latest)
...
- Свои короткие сигналы начала (восходящий) и конца (нисходящий) записи,
  не системные звуки Windows
- HUD-капсула с индикатором громкости.
