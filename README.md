...
**Установщик**: [`D1CT-1.5.3-setup.exe`](https://github.com/metawka/SuperDictate-win/releases/latest)
...
- **Стиль текста**: формальный (как выдала модель), стандартный (без
  ...
  разговорный (то же плюс точки внутри превращаются в запятые, так что
  реплика идёт одной строкой)
...
Всё находится в `%LOCALAPPDATA%\D1CT`:
