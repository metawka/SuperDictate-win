...
**Установщик**: [`Dictation-2.1.0-setup.exe`](https://github.com/metawka/SuperDictate-win/releases/latest)
...
- Приглушение системного звука на время записи. Если приложение
  завершилось аварийно во время записи, звук возвращается при следующем
  запуске
...
- Проверка обновлений (настройки, вкладка «Дополнительно»). Если версия
  новее найдена, страница релиза открывается в браузере; ничего не
  скачивается и не запускается само
