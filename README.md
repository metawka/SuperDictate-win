...
**Установщик**: [`D1CT-1.5.1-setup.exe`](https://github.com/metawka/SuperDictate-win/releases/latest)
...
- Предупреждения показываются своими карточками справа внизу, а не через
